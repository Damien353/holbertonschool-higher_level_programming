...
a la fin d'un fichier texte (UTF-8) et de retourner le nombre de
caracteres ajoutes.
"""
...
def append_write(filename="", text=""):
    """
    Ajoute une chaine de caracteres a la fin d'un fichier texte (UTF-8) et
    retourne le nombre de caracteres ajoutes.
    ...
    Cette fonction ouvre le fichier en mode ajout (ce qui cree le fichier
    s'il n'existe pas), ajoute la chaine de caracteres fournie et retourne
